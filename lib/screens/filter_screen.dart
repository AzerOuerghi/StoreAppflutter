      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            getLabel("Categories"),
            SizedBox(height: 15),
            OptionItem(text: "ACCESSOIRES VOITURE"),
            SizedBox(height: 15),
            OptionItem(text: "PLAQUETTES DE FREIN"),
            SizedBox(height: 15),
            OptionItem(text: "DISQUES DE FREIN"),
            SizedBox(height: 15),
            OptionItem(text: "OUTILLAGE & ÉQUIPEMENT"),
            SizedBox(height: 30),
            getLabel("Brand"),
            SizedBox(height: 15),
            OptionItem(text: "CITROEN"),
            SizedBox(height: 15),
            OptionItem(text: "RENAULT"),
            SizedBox(height: 15),
            OptionItem(text: "FORD"),
            SizedBox(height: 15),
            OptionItem(text: "KIA"),
            Spacer(),
            AppButton(
